...
#flat { background: none; border: none; font-size: 13px; padding-top: 7px;}
	</style>
    ...
    $(function(){
		...
		function addTab() {
			...
			$tabs.tabs('add', '#tabs-'+tab_counter-1, tab_title);
			tab_counter++;
		}
...
<ul>
	...
	?>
	<li>
    	<a id="p_tab_0" href="#p_0">
        	<?= $project->name; ?>
        </a> 
        <span id="p_tab_close_0" class="ui-icon ui-icon-close">Remove Tab</span>
    </li>
    <? 
    	endif;
    endforeach; ?>
    ...
    <span class="ui-icon ui-icon-triangle-1-s"></span>Open Project</a>
    ...
    <ul>
        ...
        ?>
        <li>
            <a id="p_tab_<?= $project->id; ?>" href="#p_<?= $project->id; ?>" class="p_tab_open">
                <?= $project->name; ?>
            </a>
        </li>
        <? 
