...
class TimeUtil{
	...
	public static function distanceOfTimeInWords($from_time, $to_time = 0, $include_seconds = false) {
		
		//Adding default timer		
		
		if (strlen(trim($to_time)) <= 0 || strlen(trim($from_time)) <= 0){
			return 'No period';
		}
